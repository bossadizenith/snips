        ...
        <DropdownMenu>
          <DropdownMenuTrigger
            render={(props) => (
              <Button
                variant="transparent"
                className="py-1 pl-1 pr-2 gap-2 data-[state=open]:bg-gray-4 text-gray-12"
              >
          ...
          <DropdownMenuContent
            align="start"
            className="p-2 gap-1.5 flex flex-col"
          >
            {links.map((link) => (
              <DropdownMenuItem
                key={link.href}
              ...
              >
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex flex-col leading-none gap-1">
                    ...
                    <span className="text-[13px] text-gray-9 group-hover:text-gray-10">
                      {link.description}
                    </span>
                  </div>
                </div>
