...
import type { KeyedToken, KeyedTokensInfo, MagicMoveDifferOptions, MatchedRanges } from "@/utils/types";
...
export function toKeyedTokens(code: string, tokens: ThemedToken[][], salt = "", lineNumbers = false): KeyedTokensInfo {
