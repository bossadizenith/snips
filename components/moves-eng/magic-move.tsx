...
export function ShikiMagicMove(props: ShikiMagicMoveProps) {
  ...
  // For explicit animation triggers (like slide transitions), use previousCode if provided
  let previousTokens: KeyedTokensInfo | undefined;
  if (props.previousCode !== undefined && props.previousCode !== props.code) {
    previousTokens = codeToKeyedTokens(
      props.highlighter,
      props.previousCode,
      {
        lang: props.lang,
  ...
  return (
    <ShikiMagicMoveRenderer
      ...
      previous={previousTokens || result.previous}
