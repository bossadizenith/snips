...
export const LANGUAGES: { [index: string]: Language } = {
  ...
  // console: {
  //   name: "Console",
  //   src: () => import("shiki/langs/cons.mjs"),
  // },
  crystal: {
    name: "Crystal",
  ...
  dockerfile: {
    name: "Docker",
    src: () => import("shiki/langs/docker.mjs"),
  },
  elm: {
    name: "Elm",
  ...
  objectivec: {
    name: "Objective-C",
    src: () => import("shiki/langs/objective-c.mjs"),
  },
  ocaml: {
    name: "OCaml",
